...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype._afterDecideResponse = function (response) {
        ...
        (_e = this.surveys) === null || _e === void 0 ? void 0 : _e.afterDecideResponse(response);
        (_f = this.webVitalsAutocapture) === null || _f === void 0 ? void 0 : _f.afterDecideResponse(response);
        (_g = this.exceptionObserver) === null || _g === void 0 ? void 0 : _g.afterDecideResponse(response);
    };
    ...
    PostHog.prototype.capture = function (event_name, properties, options) {
        ...
        data.timestamp = (options === null || options === void 0 ? void 0 : options.timestamp) || new Date();
    ...
    PostHog.prototype._calculate_event_properties = function (event_name, event_properties) {
        ...
        if (!isUndefined(startTimestamp)) {
            var duration_in_ms = new Date().getTime() - startTimestamp;
    ...
    PostHog.prototype.startSessionRecording = function (override) {
        var _a;
        var _b, _c;
        if (override === null || override === void 0 ? void 0 : override.sampling) {
